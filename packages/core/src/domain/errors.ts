...
export const ERROR_MESSAGES_EN: Record<SosoErrorCode | 'soso/unknown', string> = {
  ...
  'soso/media_not_allowed': "This kind of post can't carry a photo or video.",
  ...
  'soso/post_not_public': 'Only public pins can be shared to the chat room. Send it in a DM instead.',
  ...
  'soso/function_missing': 'This feature is not deployed on this server yet.',
